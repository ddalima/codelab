...
# User conf
########################
KUBE_CLUSTER=${KUBE_CLUSTER:-minikube}
DEFAULT_TEXT_EDITOR=${DEFAULT_TEXT_EDITOR:-gedit}
...
WEB_BROWSER=${WEB_BROWSER:-google-chrome}
...
pe "kubectl config set-context ${KUBE_CLUSTER} &&  kubectl apply -f ./nginx-deployment.yaml"
